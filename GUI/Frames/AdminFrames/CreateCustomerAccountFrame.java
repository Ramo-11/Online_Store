...
public class CreateCustomerAccountFrame extends JFrame implements ActionListener {
    JLabel nameLabel;
    JLabel pinLabel;
    ...
    CreateCustomerAccountFrame(String title, AdminController controlAdmin) {
        super(title);
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            newCustomer = new Customer(nameTextField.getText(), pinTextField.getText());
            controlAdmin.createCustomer(newCustomer);
            JOptionPane.showMessageDialog(null, "Success: Customer account has been created", "Success", JOptionPane.INFORMATION_MESSAGE);
